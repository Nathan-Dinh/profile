        ...
        <div className="w-full">
            <div className="w-[85%]">
                <div className="flex text-2xl">
                    <h2 className=" font-semibold text-white mb-4 ">Hey, Nathan here</h2>
                    <div className="hover:animate-handshake">👋</div>
                </div>
                <p> Software developer based in canada 🇨🇦</p>
                <br />
                <p> I'm deeply passionate about programming and development, constantly striving to grow and learn.</p>
            </div>
            <div className="mt-6 flex">
            <a href="https://github.com/Nathan-Dinh" target="_blank" rel="noopener noreferrer" className="mr-5 cursor-pointer relative group hover:scale-110 transition-all ">
            ...
            <a href="https://www.linkedin.com/in/nathandinh67/" target="_blank" rel="noopener noreferrer" className="mr-5 cursor-pointer relative group hover:scale-110 transition-all">
            ...
            <a href={pdf} target="_blank" className="w-40 h-10 mr-5 bg-[#020610] cursor-pointer text-gray-400 hover:text-white rounded-md flex flex-row items-center justify-center border-2 border-[#1E2A34] hover:border-[#1E2A34] focus:ring-[#1E2A34] transition-all ease-in-out duration-300 transform">
